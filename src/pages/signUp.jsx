    ...
    <SignUpContainer>
      ...
      <LeftSection>
        ...
        <LeftSubTitle className='appear'>
          Si vous avez déjà un compte chez nous, veuillez vous connecter avec
          vos informations personnelles.
        </LeftSubTitle>
        <Button1 className='appear' href="/signin">Se Connecter</Button1>
      </LeftSection>
      <RightSection>
        <RightTitle className='appear'>Créer un compte</RightTitle>
        <Socials>
          <Circle className='appear'>
            <Icon className='appear' src={facebook} />
          </Circle>
          <Circle className='appear'>
            <Icon className='appear' src={google} />
          </Circle>
          <Circle className='appear'>
            <Icon className='appear' src={linkedin} />
          </Circle>
        </Socials>
        <Form>
          <P className='appear'>Ou utilisez votre email pour l'inscription.</P>
          <Input className='appear' type="name" placeholder="Nom" required />
          ...
          <Button2 className='appear'>Créer un compte</Button2>
        </Form>
        <P className='appear' temporary={true}>J'ai déjà un compte <A href="/signin">Se Connecter</A> !</P>
      </RightSection>
